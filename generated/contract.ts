export namespace Generated {
    ...
    export namespace Types {
        export interface ComponentManifestDefinition {
            name: string | null;
            tagName: string | null;
            baseProps: (ComponentManifestPropsStylePropertyDefinition | ComponentManifestPropsBehaviorPropertyDefinition)[] | null;
            variants: string[] | null;
            variantOverrides?: {
                                [key: string]: (ComponentManifestPropsStylePropertyDefinition | ComponentManifestPropsBehaviorPropertyDefinition)[];
                            } | null;
        }
